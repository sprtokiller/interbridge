...
`;let Be=class extends(Pe(Wt)){constructor(){super(...arguments),this.offset=12,this.positionConfig={middleware:[(0,Je.cY)(this.offset)]},this.stopMouseEventPropagation=!1,this.inputRef=(0,$e._)(),this.resultsMutationObserver=new MutationObserver((()=>{const t=this.$(".response");t&&t.scrollTo(0,t.scrollHeight)})),this.handleInputSubmit=t=>{t.preventDefault(),this.submitInput()},this.handleCannedOptionSelect=t=>{this.handleCannedOption(t.detail)},this.maybeStopPropagation=t=>{this.stopMouseEventPropagation&&this.stopPropagation(t)},this.stopPropagation=t=>{t.stopPropagation()},this.handleBlur=t=>{this.dispatchEvent(new CustomEvent("blur"))},this.handlePaginationClick=t=>{const e=t.currentTarget;"decrement"===e.name&&this.decrementResponseIndex(),"increment"===e.name&&this.incrementResponseIndex(),this.status="prompt"}}get isGenerating(){return["pending","streaming"].includes(this.status)}willUpdate(t){const e=t.get("status"),i=this.status,n=this.$(".response");n&&("pending"!==e&&"pending"===i&&this.resultsMutationObserver.observe(n,{subtree:!0,childList:!0}),"pending"===e&&"prompt"===i&&this.resultsMutationObserver.disconnect())}renderSubmitButton(){if(!this.isGenerating){const t=this.userInput.length<=0;return Dt.qy`
      ...
      <div class="content">
        <div class="body">
          ...
          <div class="input-section">
            <div class="decorative-icons">${ie}</div>
    ...
    `}firstUpdated(t){super.firstUpdated(t),this.inputRef.value&&window.requestAnimationFrame((()=>{this.inputRef.value?.focus()}))}renderCannedOptionMenu(){if(!this.isGenerating)return Dt.qy`
      ...
      `:this.renderPagination()}renderPagination(){const{responseCount:t,selectedResponseIndex:e}=this,i=e+1;if(this.responseCount>1)return Dt.qy`
    ...
    `}};Be.styles=Re,(0,qt.Cg)([(0,Kt.MZ)({type:Number})],Be.prototype,"offset",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:Object})],Be.prototype,"positionConfig",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:Boolean})],Be.prototype,"stopMouseEventPropagation",void 0),(0,qt.Cg)([(0,Kt.wk)()],Be.prototype,"inputRef",void 0),Be=(0,qt.Cg)([(0,Kt.EM)("mon-ai-writer")],Be);var je=i(6678),Fe=i(1514);const Oe=Dt.AH`
...
`;let ti=class extends Wt{constructor(){super(...arguments),this.selected=!1,this.tabIndex=-1,this.role="menuitem",this.delegatesFocus=!1,this.focusableRef=(0,$e._)(),this.bindEvents=()=>{this.on("mouseenter",(()=>{this.dispatch("hover",{value:this.value,hovered:!0})})),this.on("click",this.onClick),this.on("focus",(()=>{if(this.delegatesFocus){const t=this.querySelector('a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])');t instanceof HTMLElement&&t.focus()}}))}}onClick(){this.dispatch("mon-menu-item:select")}render(){return Dt.qy`
      <slot name="icon"></slot>
      <div class="content">
        <slot></slot>
        <div class="extras">
    ...
    `}};ti.formAssociated=!0,ti.styles=Qe,ti.shadowRootOptions={...Dt.WF.shadowRootOptions,delegatesFocus:!1},(0,qt.Cg)([(0,Kt.MZ)({type:String,reflect:!0})],ti.prototype,"value",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:Boolean,reflect:!0})],ti.prototype,"selected",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:Number,reflect:!0})],ti.prototype,"tabIndex",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:String,reflect:!0})],ti.prototype,"role",void 0),(0,qt.Cg)([(0,Kt.MZ)()],ti.prototype,"delegatesFocus",void 0),(0,qt.Cg)([(0,Kt.wk)()],ti.prototype,"focusableRef",void 0),ti=(0,qt.Cg)([(0,Kt.EM)("mon-menu-item")],ti);const ei=Dt.AH`
  * {
    box-sizing: border-box;
  }
...
`;let si=class extends Wt{constructor(){super(...arguments),this.value=null,this.popoverPlacement="bottom-end",this.placeholder="Choose an item...",this.open=!1,this.labelText="",this.anchorRef=(0,$e._)(),this.scrollBarWidth=x,this.cancel=()=>{this.open&&this.dispatch("mon-select:cancel"),this.open=!1},this.onMenuEscape=()=>{this.cancel()},this.onSubmit=t=>{this.open=!1,t.stopPropagation(),this.dispatch("mon-select:change",{name:this.name,value:t.detail.value})},this.onClickOutside=()=>{this.cancel()},this.onClickTrigger=()=>{this.open?this.cancel():this.open=!0},this.onKeyDown=t=>{"ArrowLeft"===t.key&&t.stopPropagation()},this.onButtonKeyDown=t=>{"Enter"===t.key?t.preventDefault():"ArrowDown"===t.key&&(t.stopPropagation(),this.open=!0)},this.onSlotChange=()=>{this.syncLabelText()},this.syncLabelText=()=>{this.labelText=this.$$$("mon-menu-item")?.filter((t=>t.value===this.value))[0]?.innerText??this.placeholder},this.handleRefChange=t=>{this.anchorRef=t}}get $selected(){return this.$$$("mon-menu-item[selected]")[0]}bindEvents(){this.on("mon-menu:escape",this.onMenuEscape),this.on("keydown",this.onKeyDown),this.collectOff(Gt("mousedown",window,(t=>{const e=t.composedPath();t.target instanceof Node&&!e.includes(this)&&this.onClickOutside()}),{capture:!0,passive:!0}))}updated(t){t.has("value")&&this.syncLabelText(),this.open&&!1===t.get("open")&&window.requestAnimationFrame((()=>{const t=this.$$$("mon-menu-item")?.find((t=>t.value===this.value));t?.scrollIntoView({behavior:"instant",block:"nearest"})}))}renderTrigger(){return Dt.qy`
    ...
    `}renderMenu(){return this.open?Dt.qy`
        ...
        ></slot>`}renderClosedSlot(){return this.open?Dt.s6:Dt.qy`<slot name="closed"></slot>`}render(){return Dt.qy`${this.renderTrigger()}${this.renderMenu()}${this.renderClosedSlot()}`}};si.styles=ai,(0,qt.Cg)([(0,Kt.MZ)({type:String,reflect:!0})],si.prototype,"name",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:String})],si.prototype,"value",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:String})],si.prototype,"popoverPlacement",void 0),(0,qt.Cg)([(0,Kt.MZ)()],si.prototype,"placeholder",void 0),(0,qt.Cg)([(0,Kt.wk)()],si.prototype,"open",void 0),(0,qt.Cg)([(0,Kt.wk)()],si.prototype,"labelText",void 0),(0,qt.Cg)([(0,Kt.wk)()],si.prototype,"anchorRef",void 0),(0,qt.Cg)([(0,Kt.wk)()],si.prototype,"scrollBarWidth",void 0),si=(0,qt.Cg)([(0,Kt.EM)("mon-select")],si);const li=Dt.AH`
  *,
  *:before,
  *:after {
    box-sizing: border-box;
...
`;let ci=class extends Wt{constructor(){super(...arguments),this.focusedByClick=!1,this.animationDuration=250}toggleSwitch(t){!0===t?this.toggle?.classList.add("active"):!1===t?this.toggle?.classList.remove("active"):this.toggle?.classList.toggle("active")}handleClick(){this.focusedByClick=!0,this.checkboxes[0].checked=!this.checkboxes[0].checked,this.checkboxes[0].dispatchEvent(new Event("change")),setTimeout((()=>{this.focusedByClick=!1}))}handleFocus(){setTimeout((()=>{!1===this.focusedByClick&&this.toggleVisibleFocus(!0)}))}handleBlur(){this.toggleVisibleFocus(!1)}toggleVisibleFocus(t){!0===t?this.toggle.classList.add("in-focus"):this.toggle.classList.remove("in-focus")}handleCheckboxChange(t){const e=t.target;this.toggleSwitch(e.checked)}handleKeydown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this.handleClick())}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.checkboxes.forEach((t=>{this.toggleSwitch(t.checked),t.style.left="0",t.style.opacity="0.01",t.style.outline="none !important",t.style.position="absolute",t.style.top="0",t.addEventListener("focus",this.handleFocus.bind(this)),t.addEventListener("blur",this.handleBlur.bind(this)),t.addEventListener("change",this.handleCheckboxChange.bind(this)),t.addEventListener("keydown",this.handleKeydown.bind(this))}))}render(){return Dt.qy`
    ...
    `}};ci.styles=li,(0,qt.Cg)([(0,Kt.P)(".toggle")],ci.prototype,"toggle",void 0),(0,qt.Cg)([(0,Kt.P)(".control")],ci.prototype,"control",void 0),(0,qt.Cg)([(0,Kt.KN)({selector:'input[type="checkbox"]'})],ci.prototype,"checkboxes",void 0),(0,qt.Cg)([(0,Kt.wk)()],ci.prototype,"focusedByClick",void 0),(0,qt.Cg)([(0,Kt.MZ)({type:Number})],ci.prototype,"animationDuration",void 0),ci=(0,qt.Cg)([(0,Kt.EM)("mon-toggle")],ci);const di=(t,e)=>{const i=e.cssText,n=new WeakSet;return e=>{const r=e.getRootNode();if(!n.has(r)){n.add(r);const e=(r instanceof ShadowRoot?r.ownerDocument:r instanceof Document?r:document).createElement("style");e.setAttribute("data-svelte-lit-styles",t),e.textContent=i,r.appendChild(e)}}},hi=Dt.AH`
  &[data-flex='1'] {
...
`),r.Dn('<svg viewBox="0 0 100 100" data-element="button-spinner"><circle data-element="spinner-circle" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle><circle data-element="spinner-progress" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle></svg>'),r.vs('<span data-element="button-content"><!></span> <!>',1),r.vs('<a arc-button=""><!></a>'),r.vs('<button arc-button=""><!></button>');const fi=Dt.AH`
